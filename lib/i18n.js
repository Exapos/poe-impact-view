...
const I18n = (() => {
  ...
  const TRANSLATIONS = {
    ...
    cs: {
      ...
      'import.calculating':        'Počítám live staty...',
      'import.live_pending':       'Build uložen. Na pozadí inicializuji PoB engine...',
      'import.live_failed':        '⚠️ Live přepočet se nepodařil, používám uložené staty.',
      'import.engine_init':        'Inicializuji PoB engine...',
      'import.engine_mounting':    'Inicializuji PoB engine ({mounted}/{total})...',
    ...
    en: {
      ...
      'import.calculating':        'Calculating live stats...',
      'import.live_pending':       'Build saved. Initializing the PoB engine in the background...',
      'import.live_failed':        '⚠️ Live recalculation failed, using saved stats.',
      'import.engine_init':        'Initializing PoB engine...',
      'import.engine_mounting':    'Initializing PoB engine ({mounted}/{total})...',
    ...
    zh: {
      ...
      'import.calculating':        '正在计算 live 属性...',
      'import.live_pending':       '构建已保存。正在后台初始化 PoB 引擎...',
      'import.live_failed':        '⚠️ Live 重算失败，正在使用已保存属性。',
      'import.engine_init':        '正在初始化 PoB 引擎...',
      'import.engine_mounting':    '正在初始化 PoB 引擎 ({mounted}/{total})...',
