var Wasmoon = (() => {
  ...
  var empty_module_default, createRequire, fileURLToPath, pathToFileURL;
...
${traceback}`;
        ...
        var initWasmModule = (() => {
          var _scriptDir = typeof document === "undefined" && typeof location === "undefined" ? (init_empty_module(), __toCommonJS(empty_module_exports)).pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.src || new URL("index.js", document.baseURI).href;
          return (async function(moduleArg = {}) {
            ...
            if (n) {
              ...
              const { createRequire: a } = await Promise.resolve().then(() => (init_empty_module(), empty_module_exports));
              var require$1 = a(typeof document === "undefined" && typeof location === "undefined" ? (init_empty_module(), __toCommonJS(empty_module_exports)).pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.src || new URL("index.js", document.baseURI).href), fs = require$1("fs"), na = require$1("path");
              k ? r = na.dirname(r) + "/" : r = require$1("url").fileURLToPath(new URL("./", typeof document === "undefined" && typeof location === "undefined" ? (init_empty_module(), __toCommonJS(empty_module_exports)).pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.src || new URL("index.js", document.baseURI).href));
              ia = (b, c) => {
            ...
            } else M = new URL("glue.wasm", typeof document === "undefined" && typeof location === "undefined" ? (init_empty_module(), __toCommonJS(empty_module_exports)).pathToFileURL(__filename).href : typeof document === "undefined" ? location.href : _documentCurrentScript && _documentCurrentScript.src || new URL("index.js", document.baseURI).href).href;
            function Qa(a) {
              if (ka) return ka(a);
